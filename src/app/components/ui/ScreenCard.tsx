...
export default function ScreenCard({
  ...
  return (
    <div
      className={`w-full min-h-screen ${css} flex flex-col `}
      // style={{ backgroundImage: `url(${image})` }}
    >
      <div className="w-fit md:h-[70%] h-1/2 m-auto ">
        {position == "left" ? (
      ...
      <motion.div
        ...
        className="w-full h-[30%] flex flex-col justify-center "
      >
        <div className="flex w-full">
          {heading2 ? (
            <p className="md:text-4xl text-2xl font-bold text-center m-auto text-white">
