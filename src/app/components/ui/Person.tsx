          ...
          <>
            <div className="absolute top-0 left-0 w-full h-full bg-black">
              ...
              <motion.div
                ...
                className={`fixed md:w-[1000px] w-[300px] h-fit bottom-0 top-1/2 -translate-y-1/2 left-1/2 transform -translate-x-1/2 z-30 p-5 rounded-xl bg-ardent text-white flex flex-col shadow-2xl`}
              >
