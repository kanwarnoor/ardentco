    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className="absolute md:top-20 top-32 left-1/2 -translate-x-1/2 w-fit"
        >
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[70%] md:w-1/3 h-[200px] max-w-full"
        >
        ...
        >
          <p className="md:block hidden absolute bottom-10 left-1/2 transform -translate-x-1/2 text-neutral-300 text-xs md:text-base font-medium w-[80%]">
            ...
            <br /> Ardent Co. will encourage both thinkers and doers, and serve
            as an ecosystem for unleashing untapped potential.
          </p>
