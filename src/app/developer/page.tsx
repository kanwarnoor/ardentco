    ...
    <div className="h-screen w-screen flex m-auto">
      <div className="flex flex-col m-auto">
        ...
        <div className="flex flex-row">
          <Link href="https://www.linkedin.com/in/wellitsnoor" target="_blank">
            <svg
          ...
          <Link href="https://www.instagram.com/wellitsnoor" target="_blank">
            <svg
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
		...
		c3,0,5.5,0.9,7.3,2.7c1.7,1.8,2.7,4.3,2.7,7.2V39.9L48.6,39.9z"
          ...
          <Link href="https://github.com/wellitsnoor" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
