        ...
        <div className="relative m-auto flex flex-col w-full h-auto py-20 z-10 justify-center items-center min-h-screen gap-5">
          <div className="flex flex-wrap justify-center w-full h-fit text-center gap-5 mx-auto ">
            ...
            <p className="md:px-32 px-20 md:text-2xl text-xl text-center pb-20">
              ...
              online presence with targeted social media planning and execution,
              powerful brand campaigns, and influencer work that drives and
              lifts engagement. We leverage performance marketing to maximize
              ROI, optimize visibility through SEO advisory, and bring your
              vision to life with innovative creative design and development.
              Together, we craft integrated campaigns that drive measurable
              success.
            </p>
